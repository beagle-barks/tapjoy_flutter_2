    ...
    public void onMethodCall(MethodCall call, Result result) {
        if (call.method.equals("setDebugEnabled")) {
            ...
            Tapjoy.getCurrencyBalance(new TJGetCurrencyBalanceListener() {
                @Override
                public void onGetCurrencyBalanceResponse(String s, final int i) {
                    registrar.activity().runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            channel.invokeMethod("onGetCurrencyBalanceResponse", i);
                        }
                    });
                }
                ...
                public void onGetCurrencyBalanceResponseFailure(final String s) {
                    registrar.activity().runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            channel.invokeMethod("onGetCurrencyBalanceResponseFailure", s);
                        }
                    });
                }
            });
        } else if(call.method.equals("spendCurrency")) {
            int amount = (int) call.arguments;
            Tapjoy.spendCurrency(amount, new TJSpendCurrencyListener() {
                @Override
                public void onSpendCurrencyResponse(String s, final int i) {
                    registrar.activity().runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            channel.invokeMethod("onSpendCurrencyResponse", i);
                        }
                    });
                }
                ...
                public void onSpendCurrencyResponseFailure(final String s) {
                    registrar.activity().runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            channel.invokeMethod("onSpendCurrencyResponseFailure", s);
                        }
                    });
                }
            });
            ...
            Tapjoy.awardCurrency(amount, new TJAwardCurrencyListener() {
                @Override
                public void onAwardCurrencyResponse(String s, final int i) {
                    registrar.activity().runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            channel.invokeMethod("onAwardCurrencyResponse", i);
                        }
                    });
                }
                ...
                public void onAwardCurrencyResponseFailure(final String s) {
                    registrar.activity().runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            channel.invokeMethod("onAwardCurrencyResponseFailure", s);
                        }
                    });
                }
            });
            ...
            Tapjoy.setEarnedCurrencyListener(new TJEarnedCurrencyListener() {
                @Override
                public void onEarnedCurrency(String s, final int i) {
                    Log.e("FlutterTapjoyPlugin", "EARNED CURRENCY");
                    registrar.activity().runOnUiThread(new Runnable() {
                        @Override
                        public void run() {
                            channel.invokeMethod("onEarnedCurrency", i);
                        }
                    });
                }
            });
